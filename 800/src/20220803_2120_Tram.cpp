...
while bi passengers enter it. The tram is empty before it arrives at the first stop. 
...
passengers that enter the tram at the i-th stop. The stops are given from the first 
...
people in the tram immediately before it arrives at the stop. More formally, . This particularly means that a1 = 0.
...
int main()
{
    ...
    {
        cin >> out >> in;
        curr_capacity = curr_capacity - out + in;
